...
HRESULT Phantom::D3d12GraphicsManager::CreateDescriptorHeaps() 
{
    HRESULT hr;
...
HRESULT Phantom::D3d12GraphicsManager::CreateRenderTarget() 
{
    HRESULT hr;
...
HRESULT Phantom::D3d12GraphicsManager::CreateDepthStencil()
{
    HRESULT hr;
...
HRESULT Phantom::D3d12GraphicsManager::CreateVertexBuffer(const Buffer& buffer)
{
    HRESULT hr;
...
HRESULT Phantom::D3d12GraphicsManager::CreateIndexBuffer(const Buffer& buffer)
{
    HRESULT hr;
...
HRESULT Phantom::D3d12GraphicsManager::CreateTextureBuffer(const Image& image)
{
    HRESULT hr;
...
HRESULT Phantom::D3d12GraphicsManager::CreateSamplerBuffer()
{
    HRESULT hr;
...
HRESULT Phantom::D3d12GraphicsManager::CreateConstantBuffer(const Buffer& buffer)
{
    HRESULT hr;
...
HRESULT Phantom::D3d12GraphicsManager::CreateGraphicsResources()
{
    HRESULT hr;
...
void Phantom::D3d12GraphicsManager::Tick()
{
}
